...
if (isset($_GET['username']) && isset($_GET['password'])){
	...
	$query="select xitemid,xitemcode,xsource,xdesc,xlongdesc,xcat,xbrand,xgitem,xcitem,xunitsale,xtypestk,xmrp,xstdcost,xcp,xdp,xstdprice,zactive from seitem where xcat = '".$cat."' order by xitemid DESC LIMIT 6  OFFSET 0";
	$result = mysqli_query($db,$query) or die("Cannot execute query");  
