...
include_once('conect.php');
  ...
  $json_response = (array());
    ...
    $row_array['xsource'] = $row[2];
      ...
      if($pay == "COD")
      {
        $xtxntype = 'Cash On Delivery';
      }
      if($pay == "Online Payment")
      {
        $xtxntype = 'Online Payment';
      }
      if($pay == "Bkash Payment")
      {
        $xtxntype = 'Bkash Payment';
      }
...
if($stno > 0)
{
  ...
  $query =  "insert into imsetxn(xprefix,ztime,bizid,stno,ximsenum,xrow,xrdin,xitemcode,xdesc,xcat,xbrand,xsl,xsup,xsupdt,xcus, xcusdt, xwh, xbranch,  zemail, xemail, xstdcost, xstdprice,xqty,xsalesprice,xuom,xvatpct,xtxntype,xdocument,xdocumentrow,xstatus,xsign,xdate,xyear,xper,xspotcom,xpoint,xsrctaxpct )
                     values('$xprefix','$ztime','$bizid','$stno','$ximsenum','$xrow','$xrdin','$xitemcode','$xdesc','$xcat','$xbrand','$xsl','$xsup','$xsupdt','$xcus','$xcusdt','$xwh','$xbranch','$zemail','$xemail','$xstdcost','$xstdprice','$xqty','$xsalesprice','$xuom','$xvatpct','$xtxntype','$xdocument','$xdocumentrow','$xstatus','$xsign','$xdate','$xyear','$xper','$xspotcom','$xpoint','$xsrctaxpct')";
     $json_response = (array());
