...
if (isset($_GET['username']) && isset($_GET['password'])){
	...
	$query="select xitemid,xitemcode,xsource,xdesc,xlongdesc,xcat,xbrand,xgitem,xcitem,xunitsale,xtypestk,xmrp,xstdcost,xcp,xdp,xstdprice,zactive,xsup,xstdcost from seitem where zactive=1 order by xitemid DESC";
	$result = mysqli_query($db,$query) or die("Cannot execute query");  
