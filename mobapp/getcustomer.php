<?php
    ...
    $result = mysqli_query($db,"select xcus,xorg,xadd1 as address,xmobile,xgcus,xlt,xln,xpin,xopamt from secus where bizid='$zid' and xcus='$emp'") or die("Cannot execute query: $query\n");  
