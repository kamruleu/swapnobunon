...
<!-- /.content -->
	...
	<footer class="main-footer">
		...
		<strong>Copyright &copy; 2021-Continue.. <a href="#">SWAPNOBUNON</a>.</strong> All rights
		reserved.
	</footer>
...
<script src="<?php echo URL; ?>public/js/sweetalert2.all.min.js"></script>
...
<script src="<?php echo URL; ?>public/theme/extra/exporting.js"></script>
	...
	<script>
		...
		document.getElementById("helpframe").style.height = document.getElementById("helpframe").contentWindow.document.body.scrollHeight+148 + "px"; 
		}
