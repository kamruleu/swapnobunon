<div class="page-header headertext text-center">
			<?php 
			$biz = "";
			$success = "";
...
<div class="container-fluid">
	...
	<div class="col-sm-4">
      <form class="form-signin" action="<?php echo URL; ?>sendpass/sendpassword/<?php echo $biz; ?>" method="post">
		...
		<input type="text" id="xrdin" name="xrdin" class="form-control" placeholder="Email" required autofocus>
        ...
        <div class="checkbox divcentertext" >
          <label>
            <a href="<?php echo URL; ?>login/index/<?php echo $biz; ?>"><strong>Back to login</strong></a>
          </label>
        </div>
      </form>
	  </div>
