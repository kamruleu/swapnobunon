...
class Datatable{
	...
	**/
	...
	public function createTable($fields, $row, $keyval, $actionurledit="", $actionurldelete="",$actionbtn="Delete"){
		...
		foreach($row as $key=>$value){
			...
			$t=time();
			if($actionurledit!="")	
				$table.='<td><a class="btn btn-info" id="'.$value[$keyval].'"  href="'.$actionurledit.$value[$keyval].'/'.$t.'" role="button">View</a></td>';
			if($actionurldelete!="")
	...
	*/
	...
	public function myTableSubmit($fields, $row, $keyval, $actionurledit="", $actionurldelete=""){
		...
		foreach($row as $key=>$value){
			...
			if($actionurledit!="")	
				$table.='<td><a id="btndt" class="btn btn-info" onclick="showitem(\''.$showurl.'\');" href="javascript:void(0)" role="button">View</a></td>';
			if($actionurldelete!="")
	...
	**/
	public function myTable($fields, $row, $keyval, $actionurledit="", $actionurldelete="",$actionurlother="",$checknumberlit="",$voidcheck=""){
		...
		if($actionurldelete!="")
			$table.='<th>Delete</th>';
		if($actionurlother!="")
			$table.='<th>Generate</th>';
		if($checknumberlit!="")
			$table.='<th>Cheque Number List</th>';
		if($voidcheck!="")
			$table.='<th>Void Cheque</th>';
		$table.='</tr>';
		$table.='</thead>';
		$table.='<tbody>';
		foreach($row as $key=>$value){
            ...
            if($actionurlother!=""){
              if($actionurlother[$key]['status']==0){
                    $table.='<td><a id="delbtn" class="btn btn-info" href="'.URL."chequeentry/chequegenerate/".$value[$keyval].'" role="button">Generate</a></td>';
                }else{
                    $table.='<td><button type="button" class="btn btn-success" href="" role="button">Generated</button></td>';
                }

            }
            if($checknumberlit!="")
                $table.='<td><a class="btn btn-default" href="'.$checknumberlit.$value[$keyval].'" role="button">Cheque number List</a></td>';
             if($voidcheck!="")
                $table.='<td><a class="btn btn-default" href="'.$voidcheck.$value[$keyval].'" role="button">Create Void</a></td>';
