					...
					$form .= '<div id="row'.$i.'" class="form-group">';
						...
						if($selectoptions[0]=="group"){							
							...
							$form .= '<input type="text" class="form-control input-sm" id="'.$inputname.'" name="'.$inputname.'" value="'. $values[$inputname] .'" '. $lblandvalidate[1] .'>';
								...
								$form .='<button class="btn btn-default input-sm" type="button" title="Pick list for '.$lbl[0].'" 
onClick=" var acc = document.getElementById(\'xacc\').value; var accto = document.getElementById(\'xaccto\').value;  acccr=\'\'; acctocr=\'\'; bizlong=\'\'; 
if (document.getElementById(\'xacccr\')!=null)  
 var acccr = document.getElementById(\'xacccr\').value; 
if (document.getElementById(\'xacctocr\')!=null)  
 var acctocr = document.getElementById(\'xacctocr\').value;
if (document.getElementById(\'bizlong\')!=null)  
 var bizlong = document.getElementById(\'bizlong\').value;   
if (acc==\'\') acc = \'0000\'; 
if (acccr==\'\') acccr = \'0000\';
if (accto==\'\') accto = \'0000\'; 
if (acctocr==\'\') acctocr = \'0000\'; 
if (\''.$inputname.'\'==\'xaccsub\') popupCenter(baseuri+\'glchartsub/glchartsubpicklist/\'.concat(acc), \'List\', 750, 450); 
else if (\''.$inputname.'\'==\'xaccsubcr\') popupCenter(baseuri+\'glchartsub/glcrchartsubpicklist/\'.concat(acccr), \'Item List\', 750, 450); 
else if (\''.$inputname.'\'==\'xaccsubto\') popupCenter(baseuri+\'glchartsub/glchartsubpicklistto/\'.concat(accto).concat(\'/\').concat(bizlong), \'List\', 750, 450);
else if (\''.$inputname.'\'==\'xaccsubtocr\') popupCenter(baseuri+\'glchartsub/glchartsubpicklisttocr/\'.concat(acctocr).concat(\'/\').concat(bizlong), \'Item List\', 750, 450);
else if (\''.$inputname.'\'==\'xaccto\') popupCenter(\''.$selectoptions[1].'/\'.concat(bizlong), \'Item List\', 750, 450);
else if (\''.$inputname.'\'==\'xacctocr\') popupCenter(\''.$selectoptions[1].'/\'.concat(bizlong), \'Item List\', 750, 450);    
else popupCenter(\''.$selectoptions[1].'\', \'Item List\', 750, 450);">';			  
